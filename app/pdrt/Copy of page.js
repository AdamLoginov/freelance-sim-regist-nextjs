        ...
        <main className=" max-w-[1100px] xs:mx-[20px] md:mx-auto ">
            <div className="mt-[60px]">
                ...
                <div className="mb-[40px]">
                    ...
                    <p className="mb-[15px]">
                        1.2. Настоящая Политика конфиденциальности применяется только к Сайту https://reg-sim.ru/ . Сайт не контролирует и не несет ответственности за сайты третьих лиц, на которые Пользователь может перейти по ссылкам, доступным на Сайте.
                    </p>
                </div>
                ...
                <div className="mb-[40px]">
                    ...
                    <p className="mb-[15px]">
                    3.8 Пользователь вправе изменить свои персональные данные на Сайте или потребовать их удаления, направив электронное письмо по адресу: orangesim@bk.ru .
                    </p>
                    <p className="mb-[15px]">
                ...
                <div className="mb-[40px]">
                    ...
                    <p className="mb-[15px]">
                    8.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует направлять по адресу: orangesim@bk.ru .
                    </p>
                    <p className="mb-[15px]">
                    8.4. Действующая Политика конфиденциальности размещена на Сайте по адресу: https://reg-sim.ru/  сети «Интернет».
                    </p>
